...
public class PlayaTemplateV2WLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PlayaTemplateV2WLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PlayaTemplateV2WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PlayaTemplateV2WLAIW/InitOutcome.xml").getDocumentElement();
